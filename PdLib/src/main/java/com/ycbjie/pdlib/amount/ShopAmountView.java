package com.ycbjie.pdlib.amount;
 ...
 * </pre>
 */
public class ShopAmountView extends LinearLayout implements View.OnClickListener {
    ...
    public ShopAmountView(Context context, @Nullable AttributeSet attrs) {
    ...
    private void add() {
        mEtAmount.removeTextChangedListener(textWatcher);
        if(amount >= max_num){
            showToast(getContext(),"购买数量不能超过库存数"+max_num);
